        ...
        <div class="row">
  		...
  		<form>
  			<div class="form-group">
  				...
  				<input id="text" type="text" class="form-control"></input><br>
  				<label for="email">Email</label>
  				<input id="email" type="email" class="form-control"></input><br>
  				<label for="description">Problem Description</label>
  				<textarea id="description" class="form-control input-lg"></textarea><br>
