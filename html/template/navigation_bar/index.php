					...
					<ul class="nav navbar-nav">
                           <?php
                              if (!(isset($_SESSION["login"]) && $_SESSION["login"] == "Ok")){
                                 echo '<li id="welcome_message" class="text-center">Hello, guest!&nbsp;</li>';
                                 echo '<li class="text-center"><a data-toggle="modal" href="#form-modal">Login/Sign Up</a></li>';
                                 include 'login_register_modal.php';
                              }else{
                                 echo '<li id="welcome_message_logged_in">Hello, '. $_SESSION["username"].'!'.'</li>';
                                 if ($_SESSION["user_type"] == 'admin'){
                                 	echo '<li><a href="../pages/dashboard.php">Dashboard</a></li>';
                                 }else{
                                 	echo '<li><a href="../pages/account_details.php">My Account</a></li>';                               
                                 }
